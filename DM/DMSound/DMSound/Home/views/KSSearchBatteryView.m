...
- (void)creatBatteryView{
    ...
    batteryLayer.strokeColor = [UIColor colorWithHexString:@"#C5C5C5"].CGColor;
    ...
    layer2.lineWidth = 1;
    layer2.strokeColor =  [UIColor colorWithHexString:@"#C5C5C5"].CGColor;
...
-(void)createBattery:(float)num{
    ...
    CGFloat w = self.bounds.size.width;
    UIView *batteryView = [[UIView alloc]initWithFrame:CGRectMake(batteryViewxX,y+h-num-0.8,  w-batteryViewxX*2, num)];
    self.batteryV = batteryView;
   batteryView.layer.cornerRadius = 1;
   batteryView.backgroundColor = [UIColor colorWithHexString:@"#C5C5C5"];
