...
#define LineBackGroundColor [UIColor lightGrayColor]
//分割线的颜色
...
@interface LFSPopTextView ()<UIGestureRecognizerDelegate,UITextFieldDelegate> {
    NSString * titleStr;
    NSString * messageStr;
